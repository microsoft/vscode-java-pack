...
export function extensionRecommendationHandler(context: vscode.ExtensionContext, extName: string, message: string, isOptional: boolean = true) {
  ...
  if (isOptional && timeStampMap && timeStampMap[extName] !== undefined) {
    return;
  }
