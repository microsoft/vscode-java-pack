...
export class ExampleManager {
  ...
  private static INSERTLINE_EXAMPLE = "@Deprecated package com.example;\n" +
    "class Example {\n" +
  ...
  private static BRACED_CODE_TYPE_EXAMPLE = "public class EmptyClass {}\n" +
  ...
  private static BRACED_CODE_RECORD_EXAMPLE = "public record EmptyRecord(int a, int b) {}\n" +
  ...
  private static BRACED_CODE_ENUM_EXAMPLE = "public enum EmptyEnum {}\n" +
  ...
  public static getExample(example: ExampleKind): string {
    switch(example) {
      ...
      case ExampleKind.INSERTLINE_EXAMPLE:
        return ExampleManager.INSERTLINE_EXAMPLE;
      case ExampleKind.BRACED_CODE_TYPE_EXAMPLE:
        return ExampleManager.BRACED_CODE_TYPE_EXAMPLE;
      case ExampleKind.BRACED_CODE_RECORD_EXAMPLE:
        return ExampleManager.BRACED_CODE_RECORD_EXAMPLE;
      case ExampleKind.BRACED_CODE_ENUM_EXAMPLE:
        return ExampleManager.BRACED_CODE_ENUM_EXAMPLE;
